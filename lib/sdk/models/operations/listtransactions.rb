...
require_relative '../shared/transactionscursorresponse'

module OpenApiSDK
  module Operations
    class ListTransactionsRequest < OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      field :account, T.nilable(String), { 'query_param': { 'field_name': 'account', 'style': 'form', 'explode': true } }      # Pagination cursor, will return transactions after given txid (in descending order).
      ...
      # 
      field :cursor, T.nilable(String), { 'query_param': { 'field_name': 'cursor', 'style': 'form', 'explode': true } }      # Filter transactions with postings involving given account at destination (regular expression placed between ^ and $).
      ...
      # 
      field :pagination_token, T.nilable(String), { 'query_param': { 'field_name': 'pagination_token', 'style': 'form', 'explode': true } }      # Find transactions by reference field.
      ...
      sig { params(ledger: String, account: T.nilable(String), after: T.nilable(String), cursor: T.nilable(String), destination: T.nilable(String), end_time: T.nilable(DateTime), end_time_deprecated: T.nilable(DateTime), metadata: T.nilable(T::Hash[Symbol, Object]), page_size: T.nilable(Integer), page_size_deprecated: T.nilable(Integer), pagination_token: T.nilable(String), reference: T.nilable(String), source: T.nilable(String), start_time: T.nilable(DateTime), start_time_deprecated: T.nilable(DateTime)).void }
      def initialize(ledger: nil, account: nil, after: nil, cursor: nil, destination: nil, end_time: nil, end_time_deprecated: nil, metadata: nil, page_size: nil, page_size_deprecated: nil, pagination_token: nil, reference: nil, source: nil, start_time: nil, start_time_deprecated: nil)
        @ledger = ledger
        @account = account
        @after = after
        @cursor = cursor
    ...
    class ListTransactionsResponse < OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      field :transactions_cursor_response, T.nilable(Shared::TransactionsCursorResponse)

      sig { params(content_type: String, status_code: Integer, error_response: T.nilable(Shared::ErrorResponse), raw_response: T.nilable(Faraday::Response), transactions_cursor_response: T.nilable(Shared::TransactionsCursorResponse)).void }
      def initialize(content_type: nil, status_code: nil, error_response: nil, raw_response: nil, transactions_cursor_response: nil)
        @content_type = content_type
        @status_code = status_code
        @error_response = error_response
        @raw_response = raw_response
        @transactions_cursor_response = transactions_cursor_response
      end
    end
  end
end
