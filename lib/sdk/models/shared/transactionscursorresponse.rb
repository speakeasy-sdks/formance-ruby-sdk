...
module OpenApiSDK
  module Shared
    class TransactionsCursorResponseCursor < OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      sig { params(data: T::Array[Transaction], has_more: T::Boolean, page_size: Integer, next_: T.nilable(String), previous: T.nilable(String)).void }
...
# 2 - OK
    class TransactionsCursorResponse < OpenApiSDK::Utils::FieldAugmented
      extend T::Sig

      
      field :cursor, TransactionsCursorResponseCursor, { 'format_json': { 'letter_case': OpenApiSDK::Utils.field_name('cursor') } }

      sig { params(cursor: TransactionsCursorResponseCursor).void }
