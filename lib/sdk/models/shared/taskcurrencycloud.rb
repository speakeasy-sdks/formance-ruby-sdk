...
module OpenApiSDK
  module Shared
    class TaskCurrencyCloudDescriptor < OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
    ...
    class TaskCurrencyCloud < OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      field :descriptor, TaskCurrencyCloudDescriptor, { 'format_json': { 'letter_case': OpenApiSDK::Utils.field_name('descriptor') } }
      ...
      sig { params(connector_id: String, created_at: DateTime, descriptor: TaskCurrencyCloudDescriptor, id: String, state: T::Hash[Symbol, Object], status: PaymentStatusEnum, updated_at: DateTime, error: T.nilable(String)).void }
